    ...
    return (
        ...
        <div className="p-5 p-md-5  text-center bg-light shadow jumbo-image" >
            <div className="col-md-5 p-lg-2 mx-auto">
                <h1 className="display-5 text-white" id="jtext"><b>Ivaylo Korchev</b></h1>
                <p className="lead font-weight-normal text-white" id="jtext">Hello! Welcome to my page. My name is Ivaylo and I am an Aspiring React Developer. I have experience building apps with <strong className="stronk">React JavaScript Html CSS.</strong></p>
                <br></br>
